...
public class ViewMainWindow extends JFrame implements AbstractView {
    ...
    public void modelPropertyChange(final PropertyChangeEvent e) {
        ...
        /* Shot Hit and Sunk opponent's ship (Players 1 and 2) */
            ...
            /* if other player's fleet count reaches 0, display dialog box to declare winner */
        ...
        else if ((e.getPropertyName().equals(DefaultController.PLAYER2_SHOT_REPEATED) ) ||
                  (e.getPropertyName().equals(DefaultController.PLAYER1_SHOT_REPEATED) )) {
        
            JOptionPane.showMessageDialog(this, "This square has been hit. Please choose another square.");
        }
        
        else if (e.getPropertyName().equals(DefaultController.GAME_OVER)) {
            ...
            JOptionPane.showMessageDialog(this, "Game over! Player " + currentPlayer + " is the winner!");
